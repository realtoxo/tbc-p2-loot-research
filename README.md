# SSC/TK Loot Council Research

Research pack for TBC Classic Phase 2 SSC/TK loot council decisions, synthesized from Zatar's loot-priority video, Knot's SSC/TK discussions, class-specialist videos, Wowhead references, and local transcript notes.

The focus is Tier 5 tokens, weapons, trinkets, offpieces, set timing, long-lived items, later swap value, and opportunity cost.

This is not a personal BiS list. The docs are written for an LC that needs to decide who gets a drop first, whether the player can actually equip it, how long the item lasts, and what the raid loses by giving it to one spec over another.

## Start Here

| Need | Open |
|---|---|
| Raid is live and a token dropped | [Raid-Night Tier Token Quick Sheet](ssc-tk-token-drop-quick-sheet.md) |
| Raid is live and boss loot dropped | [Boss Loot Priority Tables](ssc-tk-boss-loot-priority-tables.md) |
| Write or revise token policy before raid | [Tier 5 Token Priority and Equip Constraints](ssc-tk-tier-token-priority.md) |
| Decide weapons, trinkets, and multi-phase swaps | [Weapons and Trinkets Opportunity Cost](ssc-tk-weapons-trinkets-opportunity-cost.md) |
| Route Nether Vortexes and crafted patterns | [Nether Vortex and Crafted Pattern Priority](ssc-tk-nether-vortex-priority.md) |
| Review everything boss-by-boss | [Loot Priority Guide for Loot Council](ssc-tk-loot-priority-lc-guide.md) |
| Audit source material | [sources/](sources/) |

## Document Index

| File | Purpose | Best reader |
|---|---|---|
| [ssc-tk-token-drop-quick-sheet.md](ssc-tk-token-drop-quick-sheet.md) | Fast boss-by-boss token calls. Each token has three questions, a default lane, and hard stops. | LC officer during raid |
| [ssc-tk-boss-loot-priority-tables.md](ssc-tk-boss-loot-priority-tables.md) | Boss-by-boss loot tables with explicit relative spec priority, token rows, and conditionals. | LC officer during raid |
...
| [ssc-tk-nether-vortex-priority.md](ssc-tk-nether-vortex-priority.md) | Nether Vortex routing, blacksmith weapon funneling, BoE belt lanes, BoP boot recipe traps, and crafted-pattern officer checks. | LC planning crafted loot before and during raid |
...
1. During raid, keep the [quick sheet](ssc-tk-token-drop-quick-sheet.md) open for token drops.
...
4. For Nether Vortexes and crafted patterns, use the [Nether Vortex priority guide](ssc-tk-nether-vortex-priority.md).
5. For a full boss-by-boss loot review, use the [main LC guide](ssc-tk-loot-priority-lc-guide.md).
6. When a call is controversial, check the [spec transcript synthesis](ssc-tk-spec-transcript-synthesis.md), source transcripts, and linked videos before editing policy.

## Scope

| Included | Not included |
|---|---|
| SSC/TK Phase 2 loot priority for TBC Classic | A universal BiS sheet for every player |
...
| Nether Vortex and crafted-pattern priority | Full profession economy planning |
...
| Elemental Shaman | Darkest_TV plus caster cross-checks | Good for chest/legs, Nexus Key, The Sun King's Talisman, rings, and crit/Sextant context. |
...
| Convention | Meaning |
|---|---|
| Protected set objective | A set bonus or slot plan that LC should deliberately finish, such as Mage 2p, Rogue 4p, Hunter 4p, Enhance 4p, Holy Priest 4p, Boomkin/Shadow 4p, or tank tier routing. |
| Equip constraint | A reason a player may not actually wear the item yet: Beast Lord 4p, Enhancement T4 2p, Spellfire/T5 routing, crafted chest, engineering helm, crush-immunity, or a better offset. |
| Longevity flag | The item or set remains valuable beyond the immediate lockout, lasts multiple phases, or becomes a later hit/crit/threat/tank swap. |
| Opportunity cost | The raid-level loss created by assigning a drop to one spec instead of the spec that has fewer alternatives or keeps the item longer. |
...
|---|---|---|---|
| Zatar, `TBC Classic Phase 2 Loot Priority [Fixed]` | https://www.youtube.com/watch?v=xaTf4e4y-mc | [txt](sources/xaTf4e4y-mc-transcript.txt), [tsv](sources/xaTf4e4y-mc-transcript.tsv) | Starting LC framing, boss-by-boss loot, token priorities, opportunity-cost language |
| Knot SSC loot discussion | https://www.youtube.com/watch?v=bNUu6oy2keM | [txt](sources/class-video-transcripts/knot-ssc-loot.txt), [tsv](sources/class-video-transcripts/knot-ssc-loot.tsv) | SSC cross-checks, Tsunami, healer mace, physical offsets, token nuance |
| Knot TK loot discussion | https://www.youtube.com/watch?v=1HVrxFGDfj4 | [txt](sources/class-video-transcripts/knot-tk-loot.txt), [tsv](sources/class-video-transcripts/knot-tk-loot.tsv) | TK cross-checks, Rod, Champion shoulders, Warp-Spring Coil, Kael loot |
| Simonize Rogue Phase 2 BiS | https://www.youtube.com/watch?v=6ajz-TPRHqE | [txt](sources/class-video-transcripts/simonize-rogue-p2-bis.txt), [tsv](sources/class-video-transcripts/simonize-rogue-p2-bis.tsv) | Rogue 4p, Talon of Azshara, Warp-Spring Coil, Tsunami pass, ranged stat stick |
| Sarthe Hunter T5 loot | https://www.youtube.com/watch?v=W2J4DOYFbl0 | [txt](sources/class-video-transcripts/sarthe-hunter-t5-loot.txt), [tsv](sources/class-video-transcripts/sarthe-hunter-t5-loot.tsv) | Hunter 4p timing, bow priority, trinkets, melee stat sticks |
| Bigbobbedboi Hunter Phase 2 BiS | https://www.youtube.com/watch?v=Y2smIlhPKhE | [txt](sources/class-video-transcripts/bigbobbedboi-hunter-p2-bis.txt), [tsv](sources/class-video-transcripts/bigbobbedboi-hunter-p2-bis.tsv) | Survival-specific rings, weapons, tier legs, Badge of Tenacity, hit-set swaps |
| Crix Warlock Phase 2 gear | https://www.youtube.com/watch?v=QX022x5-ICk | [txt](sources/class-video-transcripts/crix-warlock-p2-gear.txt), [tsv](sources/class-video-transcripts/crix-warlock-p2-gear.tsv) | Warlock offpiece plan, Fang, Fathomstone, Wand, Vashj chest, PvP weapon alternative |
| Fearstreet Arcane Mage Phase 2 BiS | https://www.youtube.com/watch?v=-1_R0UYJygI | [txt](sources/class-video-transcripts/fearstreet-arcane-mage-p2-bis.txt), [tsv](sources/class-video-transcripts/fearstreet-arcane-mage-p2-bis.tsv) | Mage 2p urgency, Hero-token pressure, caster routing |
| NicB Arcane Mage loot priority | https://www.youtube.com/watch?v=DWHoYNBm1QQ | [txt](sources/class-video-transcripts/nicb-arcane-mage-loot-prio.txt), [tsv](sources/class-video-transcripts/nicb-arcane-mage-loot-prio.tsv) | Mage item ordering, Nexus Key, Serpent-Coil Braid, Vestments not mage-first |
| Darkest_TV Elemental Shaman Phase 2 | https://www.youtube.com/watch?v=70IrgKs4kZg | [txt](sources/class-video-transcripts/darkest-ele-shaman-p2-final.txt), [tsv](sources/class-video-transcripts/darkest-ele-shaman-p2-final.tsv) | Elemental chest/legs, Nexus Key, The Sun King's Talisman, Ring of Endless Coils, crit notes |
...
| Source | URL | Used for |
|---|---|---|
| Wowhead SSC loot guide | https://www.wowhead.com/tbc/guide/serpentshrine-cavern-ssc-loot-gear-guide-burning-crusade-classic | Boss loot and item/source cross-checks |
| Wowhead TK loot guide | https://www.wowhead.com/tbc/guide/the-eye-raid-gear-loot-burning-crusade-classic-wow | Boss loot and item/source cross-checks |
| Wowhead Tier 5 overview | https://www.wowhead.com/tbc/guide/tier-5-set-overview-burning-crusade-classic | Token class mapping, slot sources, and set-bonus references |
| Wowhead Enhancement Shaman Phase 2 BiS | https://www.wowhead.com/tbc/guide/classes/shaman/enhancement/dps-bis-gear-pve-phase-2 | Enhancement 4p, Rod/Talon, shoulder routing, speed and trinket notes |
| Wowhead Fury Warrior Phase 2 BiS | https://www.wowhead.com/tbc/guide/classes/warrior/fury/dps-bis-gear-pve-phase-2 | Fury main-hand/offhand ladder, swing-sync warning, race-specific alternatives |
| Wowhead Warglaive loot priority | https://www.wowhead.com/tbc/news/warglaive-loot-priority-in-burning-crusade-classic-325693 | Future Rogue/Fury Warglaive context |

Transcript files are local research artifacts. They may contain YouTube auto-caption errors, so the policy docs synthesize and cross-check claims rather than treating transcript wording as exact quotation.

## Publishing Notes

- This repo is documentation-only; there is no build or test command.
- Add a `LICENSE` before encouraging public reuse.
- Review the docs against your actual raid roster before using them as binding policy.
- The LC ledger template in the tier-token doc is intended to be copied into a roster-specific planning sheet.
